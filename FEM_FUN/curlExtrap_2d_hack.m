function [localmat] = curlExtrap_2d_hack(xy_pts, triag_no) 
%
...
% the basis functions.
   ...
   Vel1 = ExtrapTerm([Vstart]) ;
   Vstart = Vstart + 1 ;
   Vel2 = ExtrapTerm([Vstart]) ;
...
localmat(1,:) = Vel2.' * Gradx - Vel1.' * Grady;
localmat(2,:) = Vel2.' * Gradx - Vel1.' * Grady;
