function [localmat] = inner_prod_ten1_VDiv_ten1_test(triag_no, quad_rul, ...
   V_fun, ten1a_type, ten1b_type, ten1a, Gradtrue1) 
%
...
Vfun_vals = feval(V_fun, quad_pts, triag_no,ten1a) ;
%Vfun_vals = velFunBDF2_test(quad_pts,triag_no) ;
%norm(Vfun_vals - Vfun_vals2)
