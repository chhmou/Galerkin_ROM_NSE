function [localmat] = inner_prod_VDiv_ten1_ten1(triag_no, quad_rul, ...
   V_fun, ten1a_type, ten1b_type) 
%
% This function computes, for triangle triag_no, the integrals
% of the (vector) Vfun Div ten1a basis functions dot product with
% the (vector) ten1b basis functions.
