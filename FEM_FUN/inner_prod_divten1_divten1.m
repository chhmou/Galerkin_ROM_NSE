function [localmat] = inner_prod_divten1_divten1(triag_no, quad_rul, ...
   scal_fun, ten1_type, ten0_type) 
%
...
localmat = [intphix * phix.' , intphiy * phix.' ; intphix * phiy.' , intphiy * phiy.' ];
