...
for itrg=1:size(elnode,1)
   ...
   temp2(1:nqpts) = (Gradsumv_vals(1,1,:) + Gradsumv_vals(2,2,:)) ;
   
   preErr2 = preErr2 + quad_wghts * ( (pfun_valsSV - gamma*temp2).^2 ).' ;
   preErr3 = preErr3 + quad_wghts * ( (pfun_valsSV + gamma*temp2).^2 ).' ;
