function [localmat] = inner_prod_ten1_ten1_SqM(triag_no, quad_rul, ...
   SqMat, ten1a_type, ten1b_type) 
%
...
mat1 = ten1a * ( ten1b * diag(a11vec) ).' ;
mat2 = ten1a * ( ten1b * diag(a21vec) ).' ;
mat3 = ten1a * ( ten1b * diag(a12vec) ).' ;
mat4 = ten1a * ( ten1b * diag(a22vec) ).' ;
