function [localmat] = GradvelFunPrevTimedef(xy_pts, triag_no) 
%
...
localmat(1,1,:) = 0.5 * ( Vel1.' * Gradx + Vel1.' * Gradx);
localmat(1,2,:) = 0.5 * ( Vel2.' * Gradx + Vel1.' * Grady);
localmat(2,1,:) = 0.5 * ( Vel1.' * Grady + Vel2.' * Gradx);
localmat(2,2,:) = 0.5 * ( Vel2.' * Grady + Vel2.' * Grady);
