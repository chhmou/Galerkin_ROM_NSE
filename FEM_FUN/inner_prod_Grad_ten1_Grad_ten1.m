function [localmat] = inner_prod_Grad_ten1_Grad_ten1(triag_no, quad_rul, ...
   scal_fun, ten1a_type, ten1b_type) 
%
% This function computes, for triangle triag_no, the integrals
% of the gradient of (vector) ten1a basis functions times 
% the gradient of (vector) ten1b basis functions multiplied by the scalar
