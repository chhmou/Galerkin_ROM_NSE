function myNSEfunction(k, sample_point)  
...
global nodeco  elnode problem vel_bas_type  pre_bas_type nVert GlobalV
global GlobalP
  ...
  pre_bas_type = 'DCtsLin' ;  %%% change to CtsLin for Taylor-Hood
